import 'package:adaptive_design/common_create_form.dart';
...
class LoginMobilePortrait extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Container(
          color: Colors.white, child: CommonCreateForm(deviceType: 'tablet')),
    ));
  }
}
  ...
  Container buildContainer(BuildContext context) {
    return Container(
      ...
      child: Container(
          ...
          color: Colors.white,
          child: CommonCreateForm(deviceType: 'tablet')),
    );
  }
}
  ...
  Container buildContainer(BuildContext context) {
    return Container(
      ...
      child: Container(
          ...
          color: Colors.white,
          child: CommonCreateForm(deviceType: 'tablet_landscape')),
    );
  }
}
  ...
  Container buildContainer(BuildContext context) {
    return Container(
      ...
      child: Container(
          ...
          color: Colors.white,
          child: CommonCreateForm(deviceType: 'desktop_protrait')),
    );
  }
}
